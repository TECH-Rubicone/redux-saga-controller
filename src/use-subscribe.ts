...
// // private HOOK
// const useReducerSubscribe = <Type extends string, Initial>(controller: Controller<Type, Initial>) : null => {
...
//
// // HOOK
// export const useSubscribe = <Type extends string, Initial>(controller: Controller<Type, Initial>): boolean => {
